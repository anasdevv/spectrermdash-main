...
const DailySpecials: React.FC<TableProps> = ({ data, count, page, onPageChange, rowsPerPage, onRowsPerPageChange, handleSearchChange }) => {
    return (
        <TableWrapper
            title='Users'
            count={count}
            ...
            <div className="overflow-x-auto w-full">
                <div className="flex min-w-max w-full">
                    ...
                    <div className="flex-none w-[20%] p-2.5 xl:p-5 bg-[#3c4fe0] text-white">
                        <h6 className="text-xs font-medium uppercase">Happy Hours</h6>
                    </div>
                    <div className="flex-none w-[20%] p-2.5 xl:p-5 bg-[#3c4fe0] text-white">
                        <h6 className="text-xs font-medium uppercase">Kids Menu</h6>
                    </div>
                </div>
                ...
                {data.map((rowData, rowIndex) => (
                    <div className="flex min-w-max border-b cursor-pointer hover:bg-gray dark:hover:bg-gray-100 hover:text-black dark:hover:text-black " style={{ borderColor: '#e2e8f0' }} key={rowIndex}>
                        ...
                        <div className="flex-none w-[20%] px-2.5 pt-2  xl:px-5 ml-3">
                            <Link href="">
                                <Tooltip title="Happy Hour" placement="right">
                        ...
                        <div className="flex-none w-[20%] px-2.5 pt-2  xl:px-5">
                            <Link href="">
                                <Tooltip title="Kid menu" placement="right">
