                  ...
                  return (
                    <React.Fragment>
                      ...
                      <li>
                        <Link
                          href="/foodcategory"
                          className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('foodcategory') &&
                            'bg-graydark dark:bg-meta-4'
                            }`}
                        >
                      ...
                      <li>
                        <Link
                          href="/amenities"
                          className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('amenities') &&
                            'bg-graydark dark:bg-meta-4'
                            }`}
                        >
                      ...
                      <li>
                        <Link
                          href="/featured"
                          className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('featured') &&
                            'bg-graydark dark:bg-meta-4'
                            }`}
                        >
                          <FeaturedVideoOutlinedIcon fontSize="small" />
                          Featured
                        </Link>
                      </li>
                      <li>
                        <Link
                          href="/dailyspecials"
                          className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('dailyspecials') &&
                            'bg-graydark dark:bg-meta-4'
                            }`}
                        >
                      ...
                      <li>
                        <Link
                          href="/dining"
                          className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('dining') &&
                            'bg-graydark dark:bg-meta-4'
                            }`}
                        >
                          <DinnerDiningOutlinedIcon fontSize="small" />
                          Dining
                        </Link>
                      </li>
                      <li>
                        <Link
                          href="/eventpage"
                          className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('eventpage') &&
                            'bg-graydark dark:bg-meta-4'
                            }`}
                        >
                      ...
                      <li>
                        <Link
                          ...
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === "/forms/pro-form-layout" &&
                            "bg-graydark dark:bg-meta-4"
                            } `}
                        >
                      ...
                      <li>
                        <Link
                          ...
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === "/pages/pricing-tables" &&
                            "bg-graydark dark:bg-meta-4"
                            } `}
                        >
                      ...
                      <li>
                        <Link
                          href="/calendar"
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === "/calendar" &&
                            "bg-graydark dark:bg-meta-4"
                            }`}
                        >
                      ...
                      <li>
                        <Link
                          href="/pages/settings"
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === "/pages/settings" && "bg-graydark dark:bg-meta-4"
                            }`}
                        >
                      ...
                      <li>
                        <Link
                          href="/pages/team"
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === "/pages/team" && "bg-graydark dark:bg-meta-4"
                            }`}
                        >
                      ...
                      <li>
                        <Link
                          ...
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === "/pages/terms-conditions" &&
                            "bg-graydark dark:bg-meta-4"
                            }`}
                        >
                      ...
                      <li>
                        <Link
                          href="/auth/signin"
                          className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === "/auth/signin" && "bg-graydark dark:bg-meta-4"
                            }`}
                        >
              ...
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      {/* <Link
                        href="/Users/apptycoons/Desktop/tailadmin-nextjs-pro-main/src/app/pages/Dashboard.tsx"
