...
import { GetSingleData } from "@/Networkcalls/ServerReq";
  ...
  const handleSubmit = useCallback(
    async (event: FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        if (
          response.admin_email === userCredentials.email &&
          response.admin_password === userCredentials.password
        ) {
          localStorage.setItem("uid", response.admin_uid);
    ...
    [userCredentials, validate, router],
  );
      ...
      <div className="flex flex-wrap items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="px-26 py-17.5 text-center">
            <h4 className=" text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
              Kalamazoo
            </h4>
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="flex  w-full justify-center rounded-md border border-primary px-9 py-3 text-center font-medium text-primary hover:bg-primary hover:text-white"
              >
                Sign In
              </button>
